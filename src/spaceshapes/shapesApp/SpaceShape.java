...
public class SpaceShape extends JPanel {
	...
	private static void createAndShowGUI() {
	    ...
	    frame.setResizable(true); //AAAAAAAAAAAAAAAAAAAAAAAAAAAAA change this back to false
	...
	private void buildGUI() {
		...
		scrollPaneForAnimation.setPreferredSize(new Dimension(404,404));//AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA 504, 504
